...
Для развертывания системы рекомендуется делать форк с последней стабильной версии системы. В данный момент стабильная версия - [1.4.6](https://github.com/itru/timesheet/tree/version_1_4_6).
